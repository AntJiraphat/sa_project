...
<body>
    <div class="profileUser-header">
        <div class="header-buttons">
            ...
            <a class="cart-button" href="javascript:void(0);" 
               onclick="goToCart('<?php echo htmlspecialchars($userRole); ?>')"
    ...
    <div class="profileUser-container">
        <div class="profileUser-menu">
            <div class="profileUser-menu-item" onclick="window.location.href='sent.php'">
                <i class="fas fa-box profileUser-menu-icon"></i>
                <p>ที่ต้องจัดส่ง</p>
            </div>

            <div class="profileUser-menu-item" onclick="window.location.href='receiveOrder.php'">
                <i class="fas fa-truck profileUser-menu-icon"></i>
                <p>ที่ต้องได้รับ</p>
            </div>

            <div class="profileUser-menu-item" onclick="window.location.href='history.php'">
    ...
    <script>
        ...
        function goToCart(role) {
            ...
            if (role === 'customer') {
                ...
                alert('คุณไม่มีสิทธิ์เข้าถึงหน้าตะกร้าสินค้า');
            }
        }
